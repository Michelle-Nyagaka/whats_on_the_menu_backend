 ### What's on the Menu ###
-This is the backend that powers our mealprep app, we use fastapi as the framework and sqlalchemy for db management
...
7. To start the backend use the command fastapi dev app.py
8. Handling migrations using alembic
